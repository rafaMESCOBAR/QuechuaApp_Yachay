...
class ExerciseGeneratorService:
    def __init__(self):
        ...
        if self.api_key:
            try:
                # ✅ CORRECCIÓN: Usar directamente la nueva versión de OpenAI 1.66.3
                self.client = openai.OpenAI(api_key=self.api_key)
                print("Cliente OpenAI (versión 1.66.3) inicializado correctamente")
    ...
    def _generate_multiple_choice(self, object_translation, user_level):
        ...
        try:
            ...
            # ✅ CORRECCIÓN: Usar la nueva sintaxis de OpenAI 1.66.3
    ...
    def _generate_matching(self, object_translation, user_level):
        ...
        try:
            ...
            # IMPORTANTE: Verificar si hay suficientes traducciones
            if len(other_translations) < 3:
                print(f"No hay suficientes traducciones para ejercicio matching. Encontradas: {len(other_translations)}")
                # Buscar más traducciones si es necesario o devolver None
                return None
    ...
    def _generate_fallback_exercises(self, object_translation, user_level):
        ...
        try:
            ...
            exercises.append(Exercise(
                ...
                metadata={
                    "time_limit": 30 - difficulty_modifier * 3,
                    "feedback_correct": [
